...
public class FileConfig implements WebMvcConfigurer{
	...
	private String profileResourcLocation;  //  file:///C:/uploadFiles/profile/
	
	// -------------------------------------------------------------------------
	// 게시판 이미지 관련 경로
	@Value("${my.board.resource-handler}")
	private String boardResourceHandler;   // my.board.resource-handler
	
	@Value("${my.board.resource_location}")
	private String boardResourceLocation;  // my.board.resource_location
