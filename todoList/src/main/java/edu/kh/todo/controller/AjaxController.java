...
public class AjaxController {
	...
	// @Autowired
	// 등록된 bean 중 같은 타입 또는 상속관계인 Bean울
	// 해당 필드에 의존성 주입(DI)
	...
	// -> "전체 Todo개수" 라는 데이터가 비동기 요청 보낸쪽으로 반환되는 것을 원함!!
	
	@ResponseBody // 반환 값을 HTTP 응답 본문으로 직접 전송 (값 그대도 돌려보낼꺼야!!)
	...
	@ResponseBody
	@PutMapping("update")
	public int updateDetail(@RequestBody Todo todo) {
		return service.updateDetail(todo);
