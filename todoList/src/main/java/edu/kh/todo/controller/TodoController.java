...
public class TodoController {
	...
	@PostMapping("update")
	public String updateForward (Todo todo, RedirectAttributes ra) {
	 ...
	 * */
	@GetMapping("delete")
	public String deleteComplete (Todo todo, RedirectAttributes ra) {
		
		
		// 서비스 메서드 호출 후 결과 반환 받기
		int result = service.deleteComplete(todo);
